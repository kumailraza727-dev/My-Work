...
const App = () => {
  return (
    <>
    <div className="navbar max-w-[1400px] w-[100%] mx-[15px] py-[30px] flex flex-row"> {/* navbar start */}
...
<div className="hero-section relative flex items-center justify-center"> {/* hero section start */}
      <div className='  items-center w-[100%] flex flex-col gap-[20px]'>
      <h1 className='text-[64px] font-semibold text-white flex leading-[74px] text-center '>Your Trusted Telecom <br /> Consultancy</h1>
     <p className='text-white'>Expert guidance for all your telecom needs today.</p>
      <a href="#check" className=' text-center border border-white rounded-[50px] p-[10px] text-[20px] font-medium w-[12%] text-white cursor-pointer'>Get Started</a>
   ...
   <div  className="hero-sections flex w-[100%] justify-around pt-[50px]">
    ...
    <h1 className='flex justify-center text-white font-semibold'>Tailored Solutions</h1>
    ...
    <h1 className='flex justify-center text-white font-semibold'>Billing Support</h1>
    ...
    <h1 className='flex justify-center text-white font-semibold'>Telecom Audits</h1>
 ...
 <div id='check' className="first-sec flex justify-center py-[30px] max-w-[1400px] w-[100%] content-end"> {/*first section start */}
  <div className='left gap-[60px] flex flex-col w-[50%] content-start justify-center'>
      <h1 className='text-[48px] font-semibold  flex leading-[58px] '>Your Trusted <br />Telecom <br /> Consultancy</h1>
     <p className=''>Expert guidance for all your telecom needs today.</p>
      <a href="" className=' text-center border border-black rounded-[50px] p-[10px] text-[20px] font-medium w-[20%]  cursor-pointer'>Get Started</a>
  </div>
   <div className="right ">
 ...
 <div id='check' className="second-sec flex justify-evenly pt-[30px] pb-[100px] max-w-[1400px] w-[100%] content-end gap-[60px]"> {/*second section start */}
   <div className="left ">
   ...
   <div className='right gap-[60px] flex flex-col w-[50%] content-start justify-center pl-[85px]'>
     <h1 className='text-[48px] font-semibold  flex leading-[58px] '>Who We Are</h1>
     <p className=''>At Rogar Communication, we empower individuals and businesses to navigate telecom choices with ease, ensuring tailored solutions for every need.</p>
  </div>
 </div> {/*second section end */}

 <div className="third-sec bg-[#E6F7FF] max-w-[1400px] w-[100%] flex pt-[50px] flex-col"> {/*third section start */}
  <div className='w-[100%] flex flex-col items-center gap-[20px] '>
    <h1 className='text-[48px] font-semibold  flex leading-[58px] '>Our Services</h1>
     <p className=''>At Rogar Communication, we empower individuals and businesses to navigate telecom choices with ease, ensuring tailored solutions for every need.</p>
  </div>
  <div  className="inner-sections flex w-[100%] justify-around pt-[50px]">
   <div className='sec-1 flex flex-col gap-y-[10px] p-[25px] bg-[#FFFFFF1F] text-center w-[30%]'>
    ...
    <h1 className='flex text-black font-semibold'>Network Issue Resolution</h1>
    ...
    <h1 className='flex text-black font-semibold'>Package Selection</h1>
    ...
    <h1 className='flex text-black font-semibold'>Telecom Audits</h1>
 ...
 <div className="fourth-sec bg-[#4A90E2] max-w-[1400px] w-[100%] flex py-[100px] flex-col align-center text-[20px] align-center text-center"> {/*fourth section start */}
  <div className='w-[100%] flex flex-col items-center gap-[20px] '>
     <p>⭐⭐⭐⭐⭐</p>
     <p className='flex content-center justify-center w-[50%] text-white'>Rogar Communication transformed my telecom experience! Their expert guidance on package selection and negotiations saved me time and money. Highly recommend their services!</p>
 ...
 <div className="footer bg-[#000] max-w-[1400px] flex py-[50px] flex-col align-center text-[20px] align-center text-center px-[100px] gap-[20px]"> {/*footer start */}
  <div className='w-[100%] flex flex-row'> 
    
    <div className='w-[33.3%] flex flex-col items-center gap-[20px] text-left '>
     <div className='gap-[20px] flex flex-col'>
      <h1 className='text-white font-semibold text-[23px] '>Services</h1>
    ...
    <div className='w-[33.3%] flex flex-col items-center gap-[20px] text-left '>
     <div className=' flex flex-col'>
      ...
      <div className='pt-[18px] '>
        <a href="tel:+1 866 456 6551"><p className='text-white text-[18px] text-left'>+1 866 456 6551</p></a>
    ...
    <form
      action="https://formsubmit.co/4340b091eed08ddb158eaa6c4001fab3"
      method="POST"
    ...
    >
      <input
        ...
        placeholder="Email"
        required
        className="w-[90%] px-4 py-1 border border-gray-300  focus:outline-none focus:ring-2 focus:ring-black bg-white mb-2"
      />
      
      <button
        type="submit"
        className="w-[90%] px-4 py-2  rounded-[50px] focus:ring-2 focus:ring-black bg-[#4A90E2] text-white capitalize text-[15px]"
      >
        Submit Now
      </button>
    </form>
